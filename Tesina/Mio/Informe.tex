...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		\hline
		$intercepto$             & 122,641 & 2,426     & 50,555 & $<0.001$ \\
		$sexo_i$                 & 3,760   & 0,747     & 5,036  & $<0.001$ \\
		$edad_i$                 & 0,167   & 0,038     & 4,357  & $<0.001$ \\
		$adherencia_{ij}$        & -2,316  & 0,923     & 2,509  & $0.012$  \\
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable					    & Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		$intercept$                     & 121,728 & 2,340     & 52,023 & $<0.001$ \\
		$sexo_i$                        & 3,801   & 0,740     & 5,133  & $<0.001$ \\
		$edad_i$                        & 0,176   & 0,038     & 4,590  & $<0.001$ \\
	    $adherencia\ perfecta_i$        & -2,763  & 1,020     & -2,708 & $0.007$ \\
		$mes_j$                         & -0,197  & 0,149     & -1,323 & $0.186$ \\
...
pacientes presentan una disminución promedio en la TAS por mes de 1.410
proporcional a la adherencia. Por ejemplo, un paciente que adhiere correctamente
sólo al 50\% del tratamiento, tendrá una disminución promedio en su TAS de 0.705
($1.410\ *\ 0.5$).
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 			 			 & Coef.   & Std. Err. & z 	    & $P<|z|$  \\
		\hline
		$intercept$                      & 122,917 & 2,849     & 43,146 & $<0.001$ \\
		$sexo_i$                         & 3,732   & 0,747     & 4,995  & $<0.001$ \\
		$edad_i$                         & 0,172   & 0,039     & 4,469  & $<0.001$ \\
		$\overline{adherencia}_i$        & -2,838  & 2,158     & -1,315 & $0.188$  \\
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 		   		   & Coef.   & Std. Err. & z      & $P<|z|$    \\
		\hline
		$intercept$                & 121,190 & 2,355 	 & 51,451 & $<0.001$   \\
		$sexo_i$                   & 3,869   & 0,751 	 & 5,151  & $<0.001$   \\
		$edad_i$                   & 0,162   & 0,039 	 & 4,197  & $<0.001$   \\
		$adherencia_{ij-1}$        & -0,254  & 0,651 	 & -0,390 & $0.697$    \\
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 				 			& Coef.   & Std. Err. & z      & $P<|z|$ \\
		\hline
		$intercept$                	   		& 123,489 & 2,489 	  & 49,622 & $<0.001$ \\
		$sexo_i$                       		& 3,721   & 0,749 	  & 4,966  & $<0.001$ \\
		$edad_i$                       		& 0,177   & 0,039 	  & 4,574  & $<0.001$ \\
		$\overline{adherencia}_{ij}$   		& -4,082  & 1,196 	  & -3,413 & $0.001$ \\
...
\begin{multline}
	\label{modelo_6}
	Y_{ij} = \beta_0 + b_{0i} + \beta_1\ sexo_i + \beta_2\ edad_i + \beta_3\ adherencia_{ij} + \beta_4\ overline{adherencia}_i
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 			 			 & Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		$intercept$            			 & 122,631 & 2,846 	   & 43,090 & $<0.001$ \\
		$sexo_i$                   		 & 3,723   & 0,747 	   & 4,983  & $<0.001$ \\
		$edad_i$                   		 & 0,171   & 0,039 	   & 4,429  & $<0.001$ \\
		$adherencia_{ij}$            	 & -2,658  & 1,054 	   & -2,521 & $0.012$  \\
		$\overline{adherencia}_i$        & 0,137   & 2,385 	   & 0,058  & $0.954$  \\
...
$ G^2(MR) - G^2(MC) = 31250.64 - 30787.86 = 462.78 $
...
$ G^2(MR) - G^2(MC) = 30838.97 - 30787.86 = 51.11 $
