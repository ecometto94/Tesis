...
%%%% chequear que estoy volviendo a definir las siglas
...
%%% si cuando se evalua la exogeneidad de la manera vista en ... se puede
%introducir al modelo sin ningun problema ya sea la var original o alguna de sus
%transformaciones. Buscar alguna forma de poner ejemplos de como queda el modelo

%%% traer las transformaciones acá
