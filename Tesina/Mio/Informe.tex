...
modelo mixto, en esta sección compararemos algunas de ellas.
...
incorrecta en algún mes. Este modelo indica que, controlando por el resto de las
...
que se le asignará es $\frac{5}{7}$ ($\approx 0.71$). Los coeficientes de este
modelo indican que, controlando por el resto de las variables, los pacientes
presentan una disminución promedio en la TAS por mes de 1.410 proporcional a la
adherencia correcta al tratamiento. Por ejemplo, un paciente que adhiere
correctamente sólo al 50\% del tratamiento, tendrá una disminución promedio en
su TAS de 0.705 ($1.410\ *\ 0.5$).
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 					  & Coef.   & Std. Err. & z 	 & $P<|z|$ \\
		\hline
		Intercept                     & 120.754 & 2.331     & 51.814 & $<0.000$ \\
		Sexo                          & 3.776   & 0.747     &  5.054 & $<0.000$ \\
		Edad                          & 0.169   & 0.038     &  4.391 & $<0.000$ \\
		tpo programa                  & 0.826   & 0.287     &  2.876 & $0.004$  \\
		tpo programa*Adherencia Total & -1.410  & 0.325     & -4.335 & $<0.000$ \\
		\hline
	\end{tabular}
\end{table}
