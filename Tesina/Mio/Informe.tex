...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		\multicolumn{3}{|c}{Var(Intercept)} & \multicolumn{2}{|c|}{93.866} \\
		\multicolumn{3}{|c}{Var(tpo programa)} & \multicolumn{2}{|c|}{2.219} \\
		\multicolumn{3}{|c}{Cov(Intercept, tpo programa)} & \multicolumn{2}{|c|}{-8.287} \\
		\hline
		Covariable   & Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		Intercept    & 121.310 & 2.361     & 51.384 & $<0.001$ \\
		Sexo         & 3.911   & 0.758     & 5.160  & $<0.001$ \\
		Edad         & 0.158   & 0.039     & 4.063  & $<0.001$ \\
		tpo programa & -0.332  & 0.106     & -3.119 & $0.002$  \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		\multicolumn{3}{|c}{Var(Intercept)} & \multicolumn{2}{|c|}{62.634} \\
		\hline
		Covariable   & Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		Intercept    & 121.431 & 2.356     & 51.547 & $<0.001$ \\
		Sexo         & 3.909   & 0.760     & 5.143  & $<0.001$ \\
		Edad         & 0.156   & 0.039     & 4.002  & $<0.001$ \\
		tpo programa & -0.332  & 0.089     & -3.707 & $<0.001$ \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		\multicolumn{3}{|c}{Var(tpo programa)} & \multicolumn{2}{|c|}{3.017} \\
		\hline
		Covariable   & Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		Intercept    & 121.941 & 1.636     & 74.516 & $<0.001$ \\
		Sexo         & 3.899   & 0.526     & 7.414  & $<0.001$ \\
		Edad         & 0.148   & 0.027     & 5.466  & $<0.001$ \\
		tpo programa & 0.332   & 0.122     & -2.719 & $0.007$  \\
		\hline
	\end{tabular}
\end{table}
