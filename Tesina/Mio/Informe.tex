...
%%%%% chequear
Aunque los métodos anteriormente descritos se han desarrollado para el análisis general con un confusor dependiente
del tiempo, en esta sección nos centramos en el caso especial de una covariable endógena.
%%%%%

% diggle 282
% Linear mixed models with endogenous covariates
