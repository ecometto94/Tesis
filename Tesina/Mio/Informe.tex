...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		\hline
		Intercept    & 121.311 & 2.355     & 51.520 & $<0.001$   \\
...
\ref{modelo_2}, controlando por el resto de las variables, los pacientes con
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable						 & Coef.   & Std. Err. & z      & $P<|z|$ \\
		\hline
		Intercept                        & 120.719 & 2.320 	   & 52.038 & $<0.001$  \\
		Sexo                             & 3.845   & 0.743     & 5.176  & $<0.001$  \\
		Edad                             & 0.169   & 0.038     & 4.414  & $<0.001$  \\
		tpo programa                     & -0.002  & 0.131 	   & -0.017 & $0.986$   \\
		tpo programa*Adherencia Perfecta & -0.666  & 0.155     & -4.286 & $<0.001$  \\
		\hline
	\end{tabular}
\end{table}
...
presentados en la tabla \ref{modelo_3} indican que, controlando por el resto de
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 					  & Coef.   & Std. Err. & z 	 & $P<|z|$ \\
		\hline
		Intercept                     & 120.754 & 2.331     & 51.814 & $<0.001$ \\
		Sexo                          & 3.776   & 0.747     &  5.054 & $<0.001$ \\
		Edad                          & 0.169   & 0.038     &  4.391 & $<0.001$ \\
		tpo programa                  & 0.826   & 0.287     &  2.876 & $0.004$  \\
		tpo programa*Adherencia Total & -1.410  & 0.325     & -4.335 & $<0.001$ \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 				& Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		Intercept               & 120.911 & 2.329 	  & 51.912 & $<0.001$ \\
		Sexo                    & 3.772   & 0.747 	  & 5.046  & $<0.001$ \\
		Edad                    & 0.165   & 0.038 	  & 4.297  & $<0.001$ \\
		tpo programa            & 0.791   & 0.171 	  & 4.613  & $<0.001$ \\
		tpo programa*Adherencia & -1.316  & 0.159 	  & -8.279 & $<0.001$ \\
		\hline
	\end{tabular}
\end{table}
...
instantánea. Los resultados se presentan en la tabla \ref{modelo_5}.
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 					& Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		Intercept                   & 121.089 & 2.341     & 51.716 & $<0.001$ \\
		Sexo                        & 3.870   & 0.751     & 5.152  & $<0.001$ \\
		Edad                        & 0.162   & 0.039     & 4.193  & $<0.001$ \\
		tpo programa                & 0.089   & 0.168     & 0.531  & $0.595$  \\
		tpo programa*Adherencia lag & -0.501  & 0.155     & -3.228 & $0.001$  \\
		\hline
	\end{tabular}
\end{table}
...
presentan en la tabla \ref{modelo_6}.
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 						  & Coef.   & Std. Err. & z      & $P<|z|$ \\
		\hline
		Intercept                         & 120.570 & 2.333     & 51.669 & $<0.001$ \\
		Sexo                              & 3.777   & 0.748     & 5.053  & $<0.001$ \\
		Edad                              & 0.171   & 0.039     & 4.448  & $<0.001$ \\
		tpo programa                      & 0.899   & 0.267     & 3.367  & $0.001$  \\
		tpo programa*Adherencia Acumulada & -1.499  & 0.298     & -5.022 & $<0.001$ \\
		\hline
	\end{tabular}
\end{table}
...
El efecto de la CVT puede dividirse en distintos coeficientes para el efecto
entre-unidad y el efecto intra-unidad, los valores de éstos coeficientes pueden
observarse en la tabla \ref{modelo_7}. El coeficiente -1.261 quiere decir que,
manteniendo constante la proporción de adherencia total al tratamiento, se
espera que la TAS disminuya en promedio 1.261 los meses en los que se adhiere
correctamente al tratamiento. Por otro lado, el coeficiente -0.246 se interpreta
como, después de controlar por la adherencia al tratamiento en ese mes, se
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable 					  & Coef.   & Std. Err. & z      & $P<|z|$  \\
		\hline
		Intercept                     & 120.832 & 2.330     & 51.855 & $<0.001$ \\
		Sexo                          & 3.754   & 0.747     &  5.023 & $<0.001$ \\
		Edad                          & 0.167   & 0.039     &  4.333 & $<0.001$ \\
		tpo programa                  & 0.946   & 0.286     &  3.307 & $0.001$  \\
		tpo programa*Adherencia       & -1.261  & 0.178     & -7.078 & $<0.001$ \\
		tpo programa*Adherencia Total & -0.246  & 0.363     & -0.678 & $0.498$  \\
		\hline
	\end{tabular}
\end{table}
