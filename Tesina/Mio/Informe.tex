...
adhiere al segundo mes, su TAS promedio sera 2,366 unidades menor
($-1,524*1 + 0,371*2 - 0,792*2*1$) mientras que un paciente que no adhiere tendra
una TAS promedio 0,742 unidades mayor ($-1,524*0 + 0,371*2 - 0,792*2*0$).
Sin embargo, si el mismo paciente adhiere al tercer mes, su TAS será en promedio
2,787 unidades menor ($-1,524*1 + 0,371*3 - 0,792*3*1$) que un paciente que no
adhiere.}
...
presentan una TAS promedio menor en 2,491 unidades el primer mes acompañado de
...
disminución promedio de 1,828 en la TAS en relación a la proporción de
adherencia total al primer mes de tratamiento y además disminuirá en 1,01 de
...
promedio en su TAS de 0,914 ($1,828\ *\ 0.5$) en el primer mes del tratamiento
