...
covariable solo es significativa en la ordenada al origen.
...
valor que se le asignará es 5/7 ($\approx 0.71$)
...
introducirse al modelo en su forma natural.
...
\begin{table}[H]
	...
	\begin{tabular}{*{5}{|c}|}
		...
		Covariable & Coef. & Std. Err. & z & $P<|z|$ \\
		\hline
		Intercept & 122.454 & 2.425 & 50.503 & 0.000 \\
		Sexo & 3.735 & 0.745 & 5.011 & 0.000 \\
		Edad & 0.168 & 0.039 & 4.370 & 0.000 \\
