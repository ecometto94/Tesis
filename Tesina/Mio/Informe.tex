...
\begin{table}[H]
	...
	\begin{tabular}{*{7}{|c}|}
		...
		\hline
		$intercepto$ 					   & $120.719\ (<0.001)$ & $120.754\ (<0.001)$ & $120.911\ (<0.001)$ & $121.089\ (<0.001)$ & $120.570\ (<0.001)$ & $120.832\ (<0.001)$ \\
		$sexo_i$ 						   & $3.845\ (<0.001)$   & $3.776\ (<0.001)$   & $3.772\ (<0.001)$   & $3.870\ (<0.001)$   & $3.777\ (<0.001)$   & $3.754\ (<0.001)$   \\
		$edad_i$ 						   & $0.169\ (<0.001)$   & $0.169\ (<0.001)$   & $0.165\ (<0.001)$   & $0.162\ (<0.001)$   & $0.171\ (<0.001)$   & $0.167\ (<0.001)$   \\
		$mes_j$ 						   & $-0.002\ (0.986)$   & $0.826\ (0.004)$    & $0.791\ (<0.001)$   & $0.089\ (0,595)$    & $0.899\ (0.001)$    & $0.946\ (0.001)$    \\
		$mes_j*adherencia\ perfecta_i$ 	   & $-0.666\ (<0.001)$  & - 				   & - 				     & - 				   & - 					 & - 				   \\
		$mes_j*\overline{adherencia}_i$    & -					 & $-1.410\ (<0.001)$  & - 				     & - 				   & - 					 & - 				   \\
		$mes_j*adherencia_{ij}$ 		   & -					 & - 				   & $-1.316\ (<0.001)$  & - 				   & - 					 & $-1.261\ (<0.001)$  \\
		$mes_j*adherencia_{ij-1}$ 		   & - 				     & - 				   & - 				     & $-0.501\ (0.001)$   & - 					 & - 				   \\
		$mes_j*\overline{adherencia}_{ij}$ & -					 & - 				   & - 				     & - 				   & $-1.499\ (<0.001)$  & $-0.246\ (0,498)$   \\
		\hline
	\end{tabular}
\end{table}
