...
En la siguiente sección se verán distintas formas de incorporar esta CVT al
modelo, las cuales algunas si serán interpretables.
...
las covariables, \hl{los pacientes que adhieren en el mes anterior al
tratamiento presentan una disminución promedio en su TAS de 3,247 unidades al primer
mes del tratamiento, acompañado de una disminución de 0,835 unidades por mes
menores a los pacientes que no adhieren en ninguna ocasión ($\overline{adherencia}_{ij}$ = 0).}
